...
def test_beginner_onboarding_is_versioned_and_restartable() -> None:
    ...
    assert 'const ONBOARDING_VERSION = "5"' in js
...
def test_beta_phase2b_frontend_reliability_contract() -> None:
    ...
    assert 'const CACHE = "ai-stock-health-beta-v11-mobile-onboarding"' in sw
    ...
    assert "evidence.css?v=3.9.8.6" in sw
